    ...
    (r = [
        ...
        var o =
          ...
          v = function () {
            if (
              ...
              return (h = (0, d.default)(h, m)), (0, f.default)(h, m.once), h;
          };
        e.exports = {
          init: function (e) {
            (m = o(m, e)), (h = (0, p.default)());
            var t,
            ...
            return !0 === (t = m.disable) ||
              ...
              : (m.disableMutationObserver ||
                ...
                window.addEventListener(
                  "resize",
                  (0, u.default)(v, m.debounceDelay, !0)
                ),
                window.addEventListener(
                  "orientationchange",
                  (0, u.default)(v, m.debounceDelay, !0)
                ...
                window.addEventListener(
                  ...
                  (0, s.default)(function () {
                    (0, f.default)(h, m.once);
                  }, m.throttleDelay)
                ),
                m.disableMutationObserver || l.default.ready("[data-aos]", i),
                h);
          },
          refresh: v,
          refreshHard: i,
        ...
        !function (e) {
          ...
          function o(r, n, e) {
            function i(e) {
              var t = u,
                n = l;
              return (u = l = void 0), (h = e), (f = r.apply(n, t));
            }
            function o(e) {
              var t = e - p;
              return void 0 === p || n <= t || t < 0 || (m && c <= e - h);
            }
            function a() {
              var e,
                t = C();
              return o(t)
                ...
                : void (d = setTimeout(
                    a,
                    ((e = n - ((t = t) - p)), m ? k(e, c - (t - h)) : e)
                  ));
            }
            function s(e) {
              return (d = void 0), v && u ? i(e) : ((u = l = void 0), f);
            }
            function t() {
              var e = C(),
                t = o(e);
              if (((u = arguments), (l = this), (p = e), t)) {
                if (void 0 === d)
                  return (h = e = p), (d = setTimeout(a, n)), g ? i(e) : f;
                if (m) return (d = setTimeout(a, n)), i(p);
              }
              return void 0 === d && (d = setTimeout(a, n)), f;
            }
            var u,
              l,
              c,
              ...
              m = !1,
              v = !0;
            if ("function" != typeof r) throw new TypeError(x);
            return (
              (n = b(n) || 0),
              y(e) &&
                ((g = !!e.leading),
                (m = "maxWait" in e),
                (c = m ? w(b(e.maxWait) || 0, n) : c),
                (v = "trailing" in e ? !!e.trailing : v)),
              (t.cancel = function () {
                void 0 !== d && clearTimeout(d), (u = p = l = d = void (h = 0));
              }),
              (t.flush = function () {
                return void 0 === d ? f : s(C());
              }),
              t
            );
          }
          ...
          return (
            e.forEach(function (e, t) {
              e.node.classList.add("aos-init"),
                (e.position = (0, r.default)(e.node, n.offset));
            }),
            e
          );
        };
      ...
      function (e, t, n) {
        ...
        t.default = function (e, t) {
          ...
          return n + (r = o.anchorPlacement || o.offset || isNaN(t) ? r : t);
        };
      },
      function (e, t) {
        "use strict";
...
(function (e, t) {
  ...
  "object" == typeof module && "object" == typeof module.exports
    ...
    : t(e);
})("undefined" != typeof window ? window : this, function (g, M) {
  "use strict";
  function m(e) {
          ...
          if (null != (e = arguments[a]))
            for (t in e)
              (n = e[t]),
                "__proto__" !== t &&
                  o !== n &&
                  (u && n && (x.isPlainObject(n) || (r = Array.isArray(n)))
                    ? ((i = o[t]),
                      (i =
                        r && !Array.isArray(i)
                          ? []
  ...
  var e = (function (M) {
      ...
      try {
        S.apply((t = G.call(c.childNodes)), c.childNodes),
          ...
          if (11 !== f && (s = le.exec(t)))
            if ((i = s[1])) {
              ...
              if (
                ...
                return S.apply(n, e.getElementsByClassName(i)), n;
            }
          if (
            d.qsa &&
            !m[t + " "] &&
        ...
        function (e) {
          ...
          return (
            e != C &&
              ...
              (d.attributes = q(function (e) {
                return (e.className = "i"), !e.getAttribute("className");
              })),
              (d.getElementsByTagName = q(function (e) {
                return (
                  e.appendChild(C.createComment("")),
                  !e.getElementsByTagName("*").length
                );
              })),
              (d.getElementsByClassName = N.test(C.getElementsByClassName)),
              (d.getById = q(function (e) {
                return (
              ...
              (r = []),
              (h = []),
              (d.qsa = N.test(C.querySelectorAll)) &&
                (q(function (e) {
                  var t;
      ...
      (j.contains = function (e, t) {
        return (e.ownerDocument || e) != C && k(e), g(e, t);
      }),
      (j.attr = function (e, t) {
        (e.ownerDocument || e) != C && k(e);
        var n = x.attrHandle[t.toLowerCase()],
          n = n && X.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !T) : void 0;
        return void 0 !== n
          ? n
          : d.attributes || !T
          ? e.getAttribute(t)
      ...
      function we(p, h, g, m, v, e) {
        return (
          ...
          O(function (e, t, n, r) {
            ...
            } else (d = xe(d === t ? d.splice(l, d.length) : d)), v ? v(null, t, d, r) : S.apply(t, d);
          })
        );
      }
      function ke(m, v) {
        function e(e, t, n, r, i) {
          ...
          for (
            ...
            if (b && o) {
              for (
                a = 0, t || o.ownerDocument == C || (k(o), (n = !T));
                (s = m[a++]);
          ...
          if (((u += l), y && l !== u)) {
            ...
            S.apply(r, f),
              i && !e && 0 < f.length && 1 < u + v.length && j.uniqueSort(r);
          }
          return i && ((A = h), (w = d)), c;
        }
        var y = 0 < v.length,
      ...
      return (
        ...
        (p = j.tokenize =
          function (e, t) {
            ...
            return t ? a.length : a ? j.error(e) : F(e, s).slice(0);
          }),
        (W = j.compile =
          function (e, t) {
            var n,
                ...
                ((o = (function e(t) {
                  for (
                    ...
                    if ((n = x.relative[t[u].type])) f = [ye(be(f), n)];
                      ...
                      if (
                        (n = x.filter[t[u].type].apply(null, t[u].matches))[E]
                      ) {
                        for (i = ++u; i < o && !x.relative[t[i].type]; i++);
                        return we(
                          1 < u && be(f),
                          1 < u &&
                            H(
          ...
          function (e, t, n, r) {
            ...
            if (((n = n || []), 1 === c.length)) {
              if (
                ...
                if (!(t = (x.find.ID(a.matches[0].replace(D, f), t) || [])[0]))
                  return n;
              ...
              for (
                ...
                if (
                  (u = x.find[s]) &&
                  (r = u(
                    a.matches[0].replace(D, f),
                    (ce.test(o[0].type) && me(t.parentNode)) || t
                  ))
                ) {
                  if ((o.splice(i, 1), (e = r.length && H(o)))) break;
  ...
  (x.filter = function (e, t, n) {
    ...
    x.fn.extend({
      ...
      is: function (e) {
        return !!J(this, "string" == typeof e && G.test(e) ? x(e) : e || [], !1)
          .length;
      },
    });
  var Z,
      ...
      (((x.fn.init = function (e, t, n) {
        ...
        if (r[1]) {
          if (
            ...
            K.test(r[1]) && x.isPlainObject(t))
          )
            for (var r in t) m(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
          return this;
        }
        return (
          (n = b.getElementById(r[2])) && ((this[0] = n), (this.length = 1)),
          this
        );
      }).prototype = x.fn),
      (Z = x(b)),
  ...
  (x.Callbacks = function (r) {
    ...
    var o,
      ...
      f = {
        ...
        has: function (e) {
          return e ? -1 < x.inArray(e, u) : 0 < u.length;
        },
        empty: function () {
          return (u = u && []), this;
        },
    ...
    x.extend({
        ...
        var o = [
          ...
          a = {
            ...
            then: function (t, n, r) {
              ...
              return x
                .Deferred(function (e) {
                  o[0][3].add(l(0, e, m(r) ? r : c, e.notifyWith)),
                    o[1][3].add(l(0, e, m(t) ? t : c)),
                    o[2][3].add(l(0, e, m(n) ? n : ie));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          ...
          "pending" === a.state() || m(o[r] && o[r].then))
        )
          return a.then();
  ...
  x.extend({
    hasData: function (e) {
      return l.hasData(e) || C.hasData(e);
    },
    data: function (e, t, n) {
    ...
    x.fn.extend({
      data: function (n, e) {
        ...
        if (
          this.length &&
          ((i = l.get(o)), 1 === o.nodeType && !C.get(o, "hasDataAttrs"))
        ) {
          for (t = a.length; t--; )
            a[t] &&
              0 === (r = a[t].name).indexOf("data-") &&
              ((r = d(r.slice(5))), he(o, r, i[r]));
          C.set(o, "hasDataAttrs", !0);
        }
        return i;
      },
    ...
    x.extend({
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            (r = C.get(e, (t = (t || "fx") + "queue"))),
            n &&
              (!r || Array.isArray(n)
                ? (r = C.access(e, t, x.makeArray(n)))
                : r.push(n)),
            r || []
          );
      },
  ...
  function ge(e, t) {
    return (
      ...
      ("" === e.style.display && E(e) && "none" === x.css(e, "display"))
    );
  }
            ...
            "" === r.style.display &&
              ...
              (s[u] =
                ...
                (a = ye[i]) ||
                  ...
                  (ye[i] = a = "none" === a ? "block" : a)))))
          : "none" !== n && ((s[u] = "none"), C.set(r, "display", n)));
  ...
  var A = /^(?:checkbox|radio)$/i,
    ...
    S =
      ((q = b.createDocumentFragment().appendChild(b.createElement("div"))),
  ...
  function N(e, t) {
    var n =
      void 0 !== e.getElementsByTagName
        ...
        : [];
    return void 0 === t || (t && u(e, t)) ? x.merge([e], n) : n;
  }
  function ke(e, t) {
    for (var n = 0, r = e.length; n < r; n++)
      C.set(e[n], "globalEval", !t || C.get(t[n], "globalEval"));
  }
  ...
  function Te(e, t, n, r, i) {
    for (
      ...
      if ((o = e[d]) || 0 === o)
        if ("object" === h(o)) x.merge(f, o.nodeType ? [o] : o);
        else if (Ce.test(o)) {
          for (
            ...
            a = a.lastChild;
          x.merge(f, a.childNodes), ((a = c.firstChild).textContent = "");
        } else f.push(t.createTextNode(o));
    for (c.textContent = "", d = 0; (o = f[d++]); )
      if (r && -1 < x.inArray(o, r)) i && i.push(o);
      else if (((u = E(o)), (a = N(c.appendChild(o), "script")), u && ke(a), n))
        for (l = 0; (o = a[l++]); ) we.test(o.type || "") && n.push(o);
    return c;
  }
  var Ee = /^key/,
  ...
  function je(e, i, o) {
    o
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[i]) {
              if (r.length)
                ...
                (t = o(this, i)),
                this[i](),
                r !== (n = C.get(this, i)) || t ? C.set(this, i, !1) : (n = {}),
                r !== n)
              )
                return (
      ...
      : void 0 === C.get(e, i) && x.event.add(e, i, a);
  }
  (x.event = {
    global: {},
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (m && (u = m.events)) {
        ...
        x.isEmptyObject(u) && C.remove(e, "handle events");
      }
    },
    dispatch: function (e) {
      var t,
        ...
        s = x.event.fix(e),
        e = (C.get(this, "events") || Object.create(null))[s.type] || [],
      ...
      if (
        ...
        for (
          o = x.event.handlers.call(this, s, e), t = 0;
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          e = this || e;
          return (
            A.test(e.type) && e.click && u(e, "input") && je(e, "click", a), !1
          );
        },
        trigger: function (e) {
          e = this || e;
          return (
            A.test(e.type) && e.click && u(e, "input") && je(e, "click"), !0
          );
        },
        _default: function (e) {
          e = e.target;
          return (
            (A.test(e.type) && e.click && u(e, "input") && C.get(e, "click")) ||
            u(e, "a")
          );
        },
      },
  ...
  function Ie(e, t) {
    var n, r, i, o;
    if (1 === t.nodeType) {
      if (C.hasData(e) && (o = C.get(e).events))
        for (i in (C.remove(t, "handle events"), o))
  ...
  function j(n, r, i, o) {
    ...
    var e,
      ...
      p = r[0],
      h = m(p);
    if (h || (1 < f && "string" == typeof p && !y.checkClone && Oe.test(p)))
    ...
    if (
      ...
      for (s = (a = x.map(N(e, "script"), He)).length; c < f; c++)
        (u = e),
          c !== d &&
            ((u = x.clone(u, !0, !0)), s && x.merge(a, N(u, "script"))),
          i.call(n[c], u, c);
      if (s)
        for (l = a[a.length - 1].ownerDocument, x.map(a, Me), c = 0; c < s; c++)
          (u = a[c]),
            we.test(u.type || "") &&
              !C.access(u, "globalEval") &&
              x.contains(l, u) &&
  ...
  function Re(e, t, n) {
    for (var r, i = t ? x.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || x.cleanData(N(r)),
        r.parentNode &&
          (n && E(r) && ke(N(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  x.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (a = N(c), r = 0, i = (o = N(e)).length; r < i; r++)
          (s = o[r]),
            (u = a[r]),
            (l = void 0),
            "input" === (l = u.nodeName.toLowerCase()) && A.test(s.type)
              ? (u.checked = s.checked)
              : ("input" !== l && "textarea" !== l) ||
                (u.defaultValue = s.defaultValue);
      if (t)
        if (n)
          for (o = o || N(e), a = a || N(c), r = 0, i = o.length; r < i; r++)
            Ie(o[r], a[r]);
        else Ie(e, c);
      return 0 < (a = N(c, "script")).length && ke(a, !f && N(e, "script")), c;
    },
    ...
    x.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (x.cleanData(N(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (x.cleanData(N(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return j(
          ...
          function (e) {
            ...
            x.inArray(this, n) < 0 &&
              (x.cleanData(N(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
  ...
  function Be(e) {
    ...
    return (t = t && t.opener ? t : g).getComputedStyle(e);
  }
  function We(e, t, n) {
    var r,
      i = {};
  ...
  function o() {
    ...
    i &&
      ...
      T.appendChild(Xe).appendChild(i),
      (e = g.getComputedStyle(i)),
      (_e = "1%" !== e.top),
      (Ve = 12 === Ge(e.marginLeft)),
      (i.style.right = "60%"),
      (Fe = 36 === Ge(e.right)),
      (ze = 36 === Ge(e.width)),
      (i.style.position = "absolute"),
      ($e = 12 === Ge(i.offsetWidth / 3)),
      T.removeChild(Xe),
      (i = null));
  }
  function Ge(e) {
      ...
      "margin" === n && (u += x.css(e, n + p[a], !0, i)),
        r
          ...
          : ((u += x.css(e, "padding" + p[a], !0, i)),
            "padding" !== n
              ? (u += x.css(e, "border" + p[a] + "Width", !0, i))
              : (s += x.css(e, "border" + p[a] + "Width", !0, i)));
    return (
      !r &&
        0 <= o &&
        (u +=
  ...
  x.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = tt(s)), (a = x.cssHooks[t] || x.cssHooks[s]), void 0 === n)
        )
    ...
    x.each({ margin: "", padding: "", border: "Width" }, function (i, o) {
      (x.cssHooks[i + o] = {
        ...
        "margin" !== i && (x.cssHooks[i + o].set = at);
    }),
    x.fn.extend({
      css: function (e, t) {
        return f(
    ...
    (q = b.createElement("select").appendChild(b.createElement("option"))),
    (O.type = "checkbox"),
    (y.checkOn = "" !== O.value),
    (y.optSelected = q.selected),
            ...
            return void 0 === e.getAttribute
              ...
              : ((1 === o && x.isXMLDoc(e)) ||
                  (i =
                    ...
                    (x.expr.match.bool.test(t) ? lt : void 0)),
                void 0 !== n
                  ? null === n
  ...
  x.fn.extend({
    ...
    x.fn.extend({
      addClass: function (t) {
        ...
        if (m(t))
          return this.each(function (e) {
            x(this).addClass(t.call(this, e, H(this)));
          });
        if ((e = pt(t)).length)
          for (; (n = this[s++]); )
            if (((a = H(n)), (r = 1 === n.nodeType && " " + P(a) + " "))) {
              for (o = 0; (i = e[o++]); )
                r.indexOf(" " + i + " ") < 0 && (r += i + " ");
              a !== (a = P(r)) && n.setAttribute("class", a);
            }
        return this;
      },
      removeClass: function (t) {
        ...
        if (m(t))
          return this.each(function (e) {
            x(this).removeClass(t.call(this, e, H(this)));
          });
      ...
      toggleClass: function (i, t) {
        ...
        return "boolean" == typeof t && a
          ...
          ? this.each(function (e) {
              x(this).toggleClass(i.call(this, e, H(this), t), t);
            })
          : this.each(function () {
              var e, t, n, r;
              if (a)
                for (t = 0, n = x(this), r = pt(i); (e = r[t++]); )
                  n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
              else
                (void 0 !== i && "boolean" != o) ||
                  ((e = H(this)) && C.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      (!e && !1 !== i && C.get(this, "__className__")) || ""
                    ));
            });
      },
      hasClass: function (e) {
      ...
      (x.extend(x.event, {
        trigger: function (e, t, n, r) {
          ...
          if (
            3 !== n.nodeType &&
            8 !== n.nodeType &&
            !mt.test(d + x.event.triggered) &&
            (-1 < d.indexOf(".") &&
              ((d = (p = d.split(".")).shift()), p.sort()),
            (s = d.indexOf(":") < 0 && "on" + d),
            ((e = e[x.expando]
              ? e
              : new x.Event(d, "object" == typeof e && e)).isTrigger = r
              ? 2
              : 3),
            (e.namespace = p.join(".")),
            ...
            if (!r && !l.noBubble && !v(n)) {
              for (
                a = l.delegateType || d, mt.test(a + d) || (h = h.parentNode);
                h;
                h = h.parentNode
              )
                f.push(h), (o = h);
              o === (n.ownerDocument || b) &&
                f.push(o.defaultView || o.parentWindow || g);
            }
            for (i = 0; (h = f[i++]) && !e.isPropagationStopped(); )
              (c = h),
                (e.type = 1 < i ? a : l.bindType || d),
                (u =
                  (C.get(h, "events") || Object.create(null))[e.type] &&
                  C.get(h, "handle")) && u.apply(h, t),
                (u = s && h[s]) &&
                  u.apply &&
                  k(h) &&
            ...
            return (
              ...
              r ||
                ...
                (s &&
                  ...
                  ((o = n[s]) && (n[s] = null),
                  (x.event.triggered = d),
                  e.isPropagationStopped() && c.addEventListener(d, ht),
                  n[d](),
                  e.isPropagationStopped() && c.removeEventListener(d, ht),
          ...
          x.event.special[r] = {
            setup: function () {
              var e = this.ownerDocument || this.document || this,
                t = C.access(e, r);
              t || e.addEventListener(n, i, !0), C.access(e, r, (t || 0) + 1);
            },
            teardown: function () {
              var e = this.ownerDocument || this.document || this,
                t = C.access(e, r) - 1;
              t
                ? C.access(e, r, t)
                : (e.removeEventListener(n, i, !0), C.remove(e, r));
            },
          };
        }),
  ...
  (x.param = function (e, t) {
    ...
    (x.offset = {
      setOffset: function (e, t, n) {
        ...
        "static" === s && (e.style.position = "relative"),
          ...
          null != (t = m(t) ? t.call(e, n, x.extend({}, o)) : t).top &&
            (l.top = t.top - o.top + i),
    ...
    x.each(["top", "left"], function (e, n) {
      x.cssHooks[n] = Ke(y.pixelPosition, function (e, t) {
        if (t) return (t = L(e, n)), Ye.test(t) ? x(e).position()[n] + "px" : t;
      });
    }),
    x.each({ Height: "height", Width: "width" }, function (a, s) {
      x.each(
  ...
  return (
    (x.noConflict = function (e) {
      return g.$ === x && (g.$ = Ct), e && g.jQuery === x && (g.jQuery = kt), x;
    }),
    void 0 === M && (g.jQuery = g.$ = x),
    x
  );
});
