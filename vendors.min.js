  ...
  (function (e, t) {
    ...
    var e = (function (M) {
        ...
        (j.attr = function (e, t) {
          ...
          var n = x.attrHandle[t.toLowerCase()],
            n =
              n && X.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !T) : void 0;
          return void 0 !== n
            ? n
            : d.attributes || !T
            ? e.getAttribute(t)
            ...
            function (e, t, n, r) {
              ...
              if (((n = n || []), 1 === c.length)) {
                if (
                  ...
                  if (
                    !(t = (x.find.ID(a.matches[0].replace(D, f), t) || [])[0])
                  )
                    return n;
                  l && (t = t.parentNode),
    ...
    function Te(e, t, n, r, i) {
      ...
      for (c.textContent = "", d = 0; (o = f[d++]); )
        if (r && -1 < x.inArray(o, r)) i && i.push(o);
          ...
          ((u = E(o)), (a = N(c.appendChild(o), "script")), u && ke(a), n)
        )
          ...
          x.event.add(e, i, {
            ...
            handler: function (e) {
              ...
              if (1 & e.isTrigger && this[i]) {
                if (r.length)
                  (x.event.special[i] || {}).delegateType &&
                    e.stopPropagation();
                else if (
                  ((r = s.call(arguments)),
                  C.set(this, i, r),
      ...
      special: {
        ...
        click: {
          setup: function (e) {
            e = this || e;
            return (
              A.test(e.type) && e.click && u(e, "input") && je(e, "click", a),
              !1
            );
          },
          trigger: function (e) {
    ...
    function j(n, r, i, o) {
      ...
      if (
        ...
        if (s)
          for (
            l = a[a.length - 1].ownerDocument, x.map(a, Me), c = 0;
            c < s;
            c++
          )
            (u = a[c]),
    ...
    x.extend({
      ...
      clone: function (e, t, n) {
        ...
        return (
          0 < (a = N(c, "script")).length && ke(a, !f && N(e, "script")), c
        );
      },
    ...
    (x.param = function (e, t) {
      ...
      x.each(["top", "left"], function (e, n) {
        x.cssHooks[n] = Ke(y.pixelPosition, function (e, t) {
          if (t)
            return (t = L(e, n)), Ye.test(t) ? x(e).position()[n] + "px" : t;
        });
      }),
    ...
    return (
      (x.noConflict = function (e) {
        return (
          g.$ === x && (g.$ = Ct), e && g.jQuery === x && (g.jQuery = kt), x
        );
      }),
